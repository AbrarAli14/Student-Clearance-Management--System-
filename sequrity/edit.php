...
<i class="fas fa-user"></i>   </br>
 <input type="text" name="user" value="<?php echo $row ['user']?>" placeholder="Enter Username"></br>
    <input type="text" name="idnum" value="<?php echo $row ['idnum']?>"  placeholder="Enter brand"></br>
    <input type="text" name="serial" value="<?php echo $row ['serial']?>" placeholder="Enter serial number"></br>
    <input type="text" name="brand" value="<?php echo $row ['brand']?>"  placeholder="Enter brand"></br>
    <input type="text" name="color"  value="<?php echo $row ['color']?>" placeholder="Enter color"></br>
