...
<li><a href="viewrecord.php" style="font-size:17px;"><i class="fas fa-sad-tear"></i> Suspended Student</a></li>
<li><a href="search.php" style="font-size:17px;"><i class="fas fa-check-circle"></i> Student Clearance</a></li>
<li><a href="adminchat.php"style="font-size:17px;" ><i class="fas fa-comment"></i> Reported Message</a></li>
</ul>
</div>
<?php
...
<div class="end_item" style="display: flex;justify-content: space-between;">
    <p style="padding:8px;color:#fff"><?php echo $row['name']?></p>
