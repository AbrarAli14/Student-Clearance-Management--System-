...
<li><a href="adsignupg.php" style="font-size:17px;"> Add admin</a></li>
<li><a href="removeadmin.php" style="font-size:17px;"> remove admin</a></li>
<li><a href="adminchat.php"style="font-size:17px;" > update admin</a></li>
</ul>
</div>

<div class="end_item" style="display: flex;justify-content: space-between;">
    <p style="padding:8px;">pic</p>
<p><img src="ju.jpg"style="width:35px;height:35px;border-radius:100%;border:2px solid #fff"></p>
